...
module.exports = kind({
    ...
    reload: function () {
        this.log();
        this.collection.reload(this.refilter.bind(this));
    },
    ...
    components: [
    {
        ...
        components: [
            ...
            { name: "searchInput", kind: Input, placeholder: "Name or IM address", style:"flex: 1 1; vertical-align:middle;" /*, type: "search", attributes: {results:6, autosave:"contactsSearch"}, style: "font-size: 16px;"*/ },
